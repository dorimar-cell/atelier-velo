...
.DESCRIPTION
  Does steps 2-5 from the setup guide:
    2. Clone the repo (or reuse a copied folder)
    3. Check out feat/orbit-zoom-volume
    4. npm install
    5. Start Vite, wait for HTTP 200, open the snap preset
...
.PARAMETER Branch
  Branch to check out. Default: feat/orbit-zoom-volume
...
param(
  ...
  [string]$Branch = "feat/orbit-zoom-volume",
  [string]$TargetDir = "",
  [int]$Port = 5173,
  [switch]$RebuildParts,
  [switch]$NoDev,
...
Write-Step 5 "Starting Vite and opening the preset"
